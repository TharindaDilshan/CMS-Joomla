 ...
 * @since  1.6
 */
class Mdimpressum_proModelProdaten2s extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	public function __construct($config = array())
	{
		if (empty($config['filter_fields']))
		{
			$config['filter_fields'] = array(
				...
				'twitter', 'a.twitter',
				'xing', 'a.xing',
				'auslosperr', 'a.auslosperr',
				'shop', 'a.shop',
				'datenubermi', 'a.datenubermi',
			);
		}
...
if (empty($list['direction']))
{
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__mdimpressum_pro_daten2` AS a');
