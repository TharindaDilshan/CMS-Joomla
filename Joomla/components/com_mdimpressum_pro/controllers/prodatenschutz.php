 ...
 * @since  1.6
 */
class Mdimpressum_proControllerProdatenschutz extends JControllerLegacy
{
	/**
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('Prodatenschutz', 'Mdimpressum_proModel');
	...
	public function publish()
	{
		...
		if ($user->authorise('core.edit', 'com_mdimpressum_pro') || $user->authorise('core.edit.state', 'com_mdimpressum_pro'))
		{
			...
			if (!$item)
			{
				...
				$this->setRedirect(JRoute::_('index.php?option=com_mdimpressum_pro&view=prodatenschutzm', false));
			}
			else
			{
