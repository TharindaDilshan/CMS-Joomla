...
?>
    <a class="add_wishlist hasTooltips <?php echo in_array($this->product->virtuemart_product_id, $wishlistIds) ? 'active' : ''; ?>"
...
<?php
  ...
  $whishlistBD = isset($allprod['id']) ? $allprod['id'] : array();
    ?>
    <a class="add_wishlist hasTooltips <?php echo in_array($this->product->virtuemart_product_id, $whishlistBD) ? 'active' : ''; ?>"
       title="<?php echo JText::_('ADD_TO_WHISHLIST'); ?>"
       onclick="TmboxAddToWishlist('<?php echo $this->product->virtuemart_product_id; ?>');">
        <i class="fa fa-heart-o"></i>
        <span><?php echo JText::_("ADD_TO_WHISHLIST"); ?></span>
