        ...
        */
        ...
        private function onDataError($params)
        {
            if(  empty($params['data'])  )
            {
                ...
                $this->setError('Can not get any slider data slide in module  "'. $this->module_name.'".
								<br>Please insert data at parameter "Config data".
								<br>&nbsp&nbsp&nbsp1. [Title] not blank, you must insert data here.
								<br>&nbsp&nbsp&nbsp2. Then You to click "Save" before click [save] of joomla button.');
            }
        }
