 ...
 * @since  1.6
 */
class Mdimpressum_proModelLaws extends JModelList
{
/**
	* Constructor.
	*
	...
	*/
	public function __construct($config = array())
	{
		if (empty($config['filter_fields']))
		{
			$config['filter_fields'] = array(
				...
				'rechte', 'a.`rechte`',
				'haftung', 'a.`haftung`',
				'urheberrecht', 'a.`urheberrecht`',
				'bildquellen', 'a.`bildquellen`',
				'bildrechte', 'a.`bildrechte`',
				'sonstige', 'a.`sonstige`',
			);
		}
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__mdimpressum_pro_law` AS a');
