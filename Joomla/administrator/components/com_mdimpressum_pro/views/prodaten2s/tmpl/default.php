...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_mdimpressum_pro&task=prodaten2s.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'prodaten2List', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
	...
	<?php echo JHtml::_('grid.sort', 'JSTATUS', 'a.`state`', $listDirn, $listOrder); ?>
				...
				<?php foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<?php if (isset($this->items[0]->state)): ?>
							<td class="center">
	<?php echo JHtml::_('jgrid.published', $item->state, $i, 'prodaten2s.', $canChange, 'cb'); ?>
</td>
						<?php endif; ?>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_mdimpressum_pro&task=prodaten2.edit&id='.(int) $item->id); ?>">
					<?php echo $this->escape($item->uberschrift2); ?></a>
				<?php else : ?>
					<?php echo $this->escape($item->uberschrift2); ?>
				<?php endif; ?>
				</td>
