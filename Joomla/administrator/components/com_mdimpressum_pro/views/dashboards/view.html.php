 ...
 * @since  1.6
 */
class Mdimpressum_proViewDashboards extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		Mdimpressum_proHelpersMdimpressum_pro::addSubmenu('dashboards');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_MDIMPRESSUM_PRO_TITLE_DASHBOARDS'), 'dashboards.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_mdimpressum_pro&view=dashboards');
