...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_mdimpressum_pro&task=laws.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'lawList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<form action="<?php echo JRoute::_('index.php?option=com_mdimpressum_pro&view=laws'); ?>" method="post"
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="lawList">
				<thead>
				<tr>
					...
					<?php endif; ?>
									...
									<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_MDIMPRESSUM_PRO_LAWS_ID', 'a.`id`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_MDIMPRESSUM_PRO_LAWS_RECHTE', 'a.`rechte`', $listDirn, $listOrder); ?>
				</th>
				...
				<?php if (isset($item->checked_out) && $item->checked_out && ($canEdit || $canChange)) : ?>
					<?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'laws.', $canCheckin); ?>
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_mdimpressum_pro&task=law.edit&id='.(int) $item->id); ?>">
					<?php echo $this->escape($item->rechte); ?></a>
				<?php else : ?>
					<?php echo $this->escape($item->rechte); ?>
				<?php endif; ?>
				</td>
