							...
							jQuery.ajax({
								...
								success: function(responseText){
									...
									if (percent == 100) {						
										...
										var url_to_redirect = '<?php echo JRoute::_('index.php?option=com_securitycheck&controller=filemanager&view=filemanager&'. JSession::getFormToken() .'=1',false);?>';
...
<div class="securitycheck-bootstrap">
	<div id="buttonwrapper" class="buttonwrapper">
		<button class="btn btn-primary" type="button" onclick="hideElement('buttonwrapper'); runButton();"><i class="fa fa-fire"></i><?php echo JText::_( 'COM_SECURITYCHECK_FILEMANAGER_START_BUTTON' ); ?></button>
	</div>
</div>
