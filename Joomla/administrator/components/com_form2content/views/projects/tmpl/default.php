...
<?php endif;?>
		...
		<div id="filter-bar" class="btn-toolbar">
			<div class="filter-search btn-group pull-left">
				...
				<input type="text" id="contenttypes_filter_search" name="contenttypes_filter_search" placeholder="<?php echo JText::_('COM_FORM2CONTENT_PROJECTS_FILTER_SEARCH_DESC'); ?>" id="contenttypes_filter_search" value="<?php echo $this->escape($this->state->get('contenttypes.filter.search')); ?>" title="<?php echo JText::_('COM_FORM2CONTENT_PROJECTS_FILTER_SEARCH_DESC'); ?>" />
			</div>
			<div class="btn-group pull-left hidden-phone">
				<button class="btn tip" type="submit" rel="tooltip" title="<?php echo JText::_('JSEARCH_FILTER_SUBMIT'); ?>"><i class="icon-search"></i></button>
				<button class="btn tip" type="button" onclick="jQuery('#contenttypes_filter_search').val('');this.form.submit();" rel="tooltip" title="<?php echo JText::_('JSEARCH_FILTER_CLEAR'); ?>"><i class="icon-remove"></i></button>
			</div>
